...
//selecciono todas las barras generales para luego utilizarlas
let html = document.getElementById("html");
crearBarra(html);
let javascript = document.getElementById("javascript");
crearBarra(javascript);
let wordpress = document.getElementById("español");
crearBarra(español);
let photoshop = document.getElementById("ingles");
crearBarra(ingles);
...
function pintarBarra(id_barra, cantidad, indice, interval){
    ...
    if(x < cantidad){
        ...
        elementos[x].style.backgroundColor = "#139402";
    }else{
